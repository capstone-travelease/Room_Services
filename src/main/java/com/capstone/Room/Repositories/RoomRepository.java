...
public interface RoomRepository extends JpaRepository<Rooms, Long> {
    @Query("SELECT new com.capstone.Room.Entities.ResponseRooms(rd.room_id, r.room_name, room_description, rd.room_size, rd.room_bed_quantity, rd.room_capacity, atc.file_url, fac.facility_name, r.room_price) FROM Roomdetail rd \n" +
