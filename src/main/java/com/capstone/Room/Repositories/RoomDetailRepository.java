...
public interface RoomDetailRepository extends JpaRepository<Roomdetail, Long> {
    @Query("SELECT new com.capstone.Room.Entities.ResponseRoomDetail(r.room_name, rd.room_id, room_description, rd.room_size, rd.room_bed_quantity, rd.room_capacity, atc.file_url, r.room_price) FROM Roomdetail rd \n" +
