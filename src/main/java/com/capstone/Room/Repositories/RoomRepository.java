...
public interface RoomRepository extends JpaRepository<Rooms, Long> {
    @Query("SELECT new com.capstone.Room.Entities.ResponseRooms(rd.room_id, r.room_name, rd.room_size, rd.room_bed_quantity, rd.room_capacity, r.room_price) FROM Roomdetail rd \n" +
